    ...
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                <i id="divG1I" class="fa fa-minus"></i>
            </button>
        </div>
        <!-- /.box-tools -->
    </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        <div>
                            <div class="row">
                                ...
                                <div id="divAchieved" class="col-md-2 col-sm-12 col-xs-12 form-group">
                                    <label for="inputEmail3" class="control-label">
                                        Achieved:</label>
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <button type="button" class="btn btn-block btn-primary btn-sm" style="width: 50px;"
                                        id="btnAddImmunization" onclick="AddImmunization();">
                                        Add</button>
                                </div>
                            </div>
                            <!-- /.row -->
...
<div id="divTanners" class="box box-default box-solid">
    <div class="box-header with-border">
        <h3 class="box-title">
            Tanners Staging</h3>
        <div class="box-tools pull-right">
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                            ...
                            <button type="button" class="btn btn-block btn-primary btn-sm" style="width: 50px;"
                                id="btnAddTannerStaging" onclick="AddTannerStaging();">
                                Add</button>
                        </div>
                    </div>
                    <div style="min-height: 10px; max-height: 150px; overflow-y: auto; overflow-x: hidden;">
...
<!-- /.box sub box level G1 -->
<div id="divDrugHistory" class="box box-default box-solid">
    <div class="box-header with-border">
        <h3 class="box-title">
            Drug History</h3>
        <div class="box-tools pull-right">
    ...
    <!-- /.box-header -->
    <div class="box-body">
        <div class="col-md-12 col-sm-12 col-xs-12 form-group" id="divCLTM">
            <div>
                <div class="row">
                ...
                <div id="divLongTermMedication" style="visibility: hidden; display: none;">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                            <label for="inputEmail3" class="control-label">
                                Other Drug:</label>
                            <input type="text" class="form-control" id="txtDrugOther" placeholder="Other Reason"
                                maxlength="150" />
                        </div>
                        <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                        ...
                        <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                            <label for="inputEmail3" class="control-label">
                                Other Reason:</label>
                            <input type="text" class="form-control" id="txtOtherReason" placeholder="Other Reason"
                                maxlength="150" />
                        </div>
                        <div class="col-md-1 col-sm-12 col-xs-12 form-group">
                            <label for="inputEmail3" class="control-label">
        ...
        <div class="box-body">
            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                <div class="box box-primary" id="divPriorARTSection">
                    <div class="box-header with-border">
                        <h4 class="box-title">
                            Prior ART</h4>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                <i id="divPriorARTI" class="fa fa-minus"></i>
                            </button>
                        </div>
                    </div>
                    <!-- /.box-header -->
...
<!-- /.box sub box level G1 -->
<div id="divFamily" class="box box-default box-solid">
    <div class="box-header with-border">
        <h3 class="box-title">
            Family History</h3>
        <div class="box-tools pull-right">
            ...
            <div>
                ...
                <div id="divHIVFamilyMember" style="visibility: hidden; display: none;">
                    <div class="row">
                        ...
                        <div class="col-md-5 col-sm-12 col-xs-12 form-group">
                            <button type="button" class="btn btn-block btn-primary btn-sm" style="width: 50px;"
                                id="btnSearchFamilyMember" onclick="OpenFamilyPopup();">
                                Add</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                            ...
                            <select class="form-control select2" data-placeholder="Select" id="ddlSexFM" style="width: 100%;">
                            </select>
                        </div>
                        <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                            <label for="inputEmail3" class="control-label">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                            ...
                            <button type="button" class="btn btn-block btn-primary btn-sm" style="width: 50px;"
                                id="btnAddFamilyMember" onclick="AddFamilyMemberHIV();">
                                Add</button>
                        </div>
                    </div>
                    <div style="min-height: 10px; max-height: 150px; overflow-y: auto; overflow-x: hidden;">
                        <table id="dtlFMHIV" class="table table-bordered table-striped" style="padding: 4px;">
                            <thead>
                                <tr>
                                    <th style="width: 5%;">
                                        Registered
...
<!-- /.box sub box level G1 -->
<div id="divSexualHistory" class="box box-default box-solid">
    <div class="box-header with-border">
        <h3 class="box-title">
            Sexual History</h3>
        <div class="box-tools pull-right">
    ...
    <div class="box-body">
        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
            <div>
                ...
                <div id="divSexuallyActive6Months">
                    <div class="row">
                        <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                            <label for="inputEmail3" class="control-label">
...
<div class="row no-print" align="center">
    <div class="form-group">
        <div class="col-md-12" align="center">
            ...
            <button type="button" class="btn btn-primary" onclick="SaveAddtionalHx();" runat="server"
                id="btnSaveAddtionalHx" clientidmode="Static">
