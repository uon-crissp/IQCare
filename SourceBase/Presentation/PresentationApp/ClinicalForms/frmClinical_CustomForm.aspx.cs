...
public partial class frmClinical_CustomForm : BasePage, ICallbackEventHandler
{
    ...
    Panel DIVCustomItemNew = new Panel();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack != true)
        {
            ...
            BindUserDropdown(ddSignature, Session["AppUserId"].ToString());
    ...
    private void LoadFieldTypeControl(string ControlID, string Column, string FieldId, string CodeID, string Label, string AdditionalInform, string Table, string TabID, string BindSource, Boolean theEnable)
    {
        ...
        if (ControlID == "1") ///SingleLine Text Box
        {
            ...
            if (theAutoPopulate == true)
            {
                ...
                thehiddenTextAuto.CssClass = "form-control";
        ...
        else if (ControlID == "5") ///Date
        {
            ...
            theDateText.Attributes.Add("data-date-format", "dd-M-yyyy");
        ...
        else if (ControlID == "6")  /// Radio Button
        {
            ...
            theYesNoRadio1.Style.Add("class", "radio-btn");
            //theYesNoRadio1.Style.Add("checked data-toggle", "toggle");
            //theYesNoRadio1.Style.Add("data-on-text", "Yes");
            //theYesNoRadio1.Style.Add("data-off-text", "No");
            ...
            theYesNoRadio2.Style.Add("class", "radio-btn");
        ...
        else if (ControlID == "8")  /// MultiLine TextBox
        {
            ...
            if (theAutoPopulate == true)
            {
                ...
                theMultiTextAuto.Style.Add("resize", "none");
            ...
            theMultiText.Style.Add("resize", "none");
            ...
            if (Convert.ToInt32(Session["busRulChk"]) == 1)
            {
                ...
                if (theDT != null)
                {
                    for (int i = 0; i < theDT.Rows.Count; i++)
                    {
                        ...
                        theDate1.CssClass = "form-control";
                        ...
                        theNumeric.CssClass = "form-control";
                        ...
                        if (chkbox.Text == "Other")
                        {
                            ...
                            HTextother.Style.Add("resize", "none");
                            HTextother.Style.Add("class", "form-control");
        ...
        else if (ControlID == "11") ///  Drug Selection 
        {
            ...
            if (DrugType > 0)
            {
                ...
                DIVCustomItem.Controls.Add(new LiteralControl("</div>"));
                DIVCustomItem.Controls.Add(new LiteralControl("<div class='row'>"));
                DIVCustomItem.Controls.Add(new LiteralControl("<div class='col-md-12 col-sm-12 col-xs-12 form-group text-center pull-top'>"));
                ...
                DIVCustomItem.Controls.Add(new LiteralControl("</div>"));
                DIVCustomItem.Controls.Add(new LiteralControl("<div class='row'>"));
                DIVCustomItem.Controls.Add(new LiteralControl("<div class='col-md-6 col-sm-12 col-xs-12 form-group pull-top'>"));
        ...
        else if (ControlID == "12") ///  Lab Selection 
        {
            ...
            DIVCustomItem.Controls.Add(new LiteralControl("</div>"));
            DIVCustomItem.Controls.Add(new LiteralControl("<div class='row'>"));
            DIVCustomItem.Controls.Add(new LiteralControl("<div class='col-md-6 col-sm-12 col-xs-12 form-group text-center pull-top'>"));
            Button theBtn = new Button();
            theBtn.Width = 95;
            ...
            if (theDT != null)
            {
                for (int i = 0; i < theDT.Rows.Count; i++)
                {
                    ...
                    if (chkbox.Text == "Other")
                    {
                        ...
                        HTextICDCode.Style.Add("class", "form-control");
                        HTextICDCode.Style.Add("resize", "none");
        ...
        else if (ControlID == "16")  /// ICD10 Control
        {
            ...
            if (theDT != null)
            {
                ...
                for (int i = 0; i < theDT.Rows.Count; i++)
                {
                    ...
                    if (!(ht.ContainsKey(Convert.ToString("CHKMULTI-" + FieldId + theDT.Rows[i][4] + "-" + "dtl_ICD10Field" + "-" + Column))))
                    {
                        ...
                        DIVCustomItem.Controls.Add(new LiteralControl("<td width='20%' vertical-align='top'>"));
                        TextBox theCommentText = new TextBox();
                        theCommentText.CssClass = "form-control";
            ...
            DIVCustomItem.Controls.Add(new LiteralControl("<div class='col-md-3 col-sm-12 col-xs-12 form-group table-condensed'>>"));
            Button theBtn = new Button();
            theBtn.Width = 230;
        ...
        else if (ControlID == "14") //Time Control
        {
            ...
            foreach (DataRow theDR in theBDV.Rows)
            {
                ...
                else if (Convert.ToString(theDR["BusRuleId"]) == "24")
                {
                    ...
                    theButton.CssClass = "btn btn-primary";
        ...
        else if (ControlID == "20") ///  Button(Form selection) 
        {
            ...
            DIVCustomItem.Controls.Add(new LiteralControl("</div>"));
            DIVCustomItem.Controls.Add(new LiteralControl("<div class='row'>"));
            DIVCustomItem.Controls.Add(new LiteralControl("<div class='col-md-12 col-sm-12 col-xs-12 form-group text-center'>"));
            Button theBtn = new Button();
            theBtn.Width = 100;
        ...
        if (theDS.Tables["Mst_Employee"] != null)
        {
            ...
            if (Convert.ToInt32(Session["PatientVisitId"]) == 0)
            {
                ...
                if (theDV.Table != null)
                {
                    ...
                    BindUserDropdown(DropDownID, Session["AppUserId"].ToString());
                }
            }
            else
            {
    ...
    private void LoadPredefinedLabel_Field(int FeatureID, int PatientID)
    {
        ...
        if (Convert.ToInt32(theDS.Tables[14].Rows[0]["MultiVisit"]) == 0)
        {
            ...
            {
                txtvisitDate.Value = String.Format("{0:dd-MMM-yyyy}", theDS.Tables[15].Rows[0]["VisitDate"]);
        ...
        foreach (DataRow distincttabdr in theDS.Tables[23].Rows)
        {
            ...
            foreach (DataRow dr in DT.Rows)
            {
                ...
                if (Convert.ToInt32(distincttabdr["TabId"]) == Convert.ToInt32(dr["TabId"]))
                {
                        ...
                        if (dr["SectionID"].ToString() == DRLnkTable["SectionID"].ToString())
                        {
                            ...
                            if (td <= Numtds)
                            {
                                ...
                                if (((Convert.ToInt32(DRLnkTable["Controlid"]) == 9) && (Convert.ToInt32(Session["busRulChk"]) == 1)) || (Convert.ToInt32(DRLnkTable["Controlid"]) == 11) || (Convert.ToInt32(DRLnkTable["Controlid"]) == 12) || (Convert.ToInt32(DRLnkTable["Controlid"]) == 16) || Convert.ToInt32(DRLnkTable["Controlid"]) == 20)
                                {
                                    ...
                                    {
                                        DIVCustomItem.Controls.Add(new LiteralControl("<td class='border center pad5 whitebg' style='width: 50%' vertical-align='top'>"));
                                        DIVCustomItem.Controls.Add(new LiteralControl("</td>"));
                                        DIVCustomItem.Controls.Add(new LiteralControl("</tr>"));
                                        DIVCustomItem.Controls.Add(new LiteralControl("<tr>"));
                                        DIVCustomItem.Controls.Add(new LiteralControl("<td class='border center pad5 whitebg' colspan='2' style='width: 50%' vertical-align='top'>"));
                    ...
                    if (dr["IsGridView"].ToString() == "1")
                    {
                        ...
                        DIVCustomItem.Controls.Add(new LiteralControl("<table width='100%' class='table-condensed'>"));
                        DIVCustomItem.Controls.Add(new LiteralControl("<tr>"));
                        DIVCustomItem.Controls.Add(new LiteralControl("<td style='width:100%' align='center' vertical-align='top'>"));
                        ...
                        DIVCustomItem.Controls.Add(new LiteralControl("<tr>"));
                        DIVCustomItem.Controls.Add(new LiteralControl("<td  vertical-align='top'>"));
            ...
            DIVCustomItem.Controls.Add(new LiteralControl("<table width='100%' class='table-condensed'>"));
            DIVCustomItem.Controls.Add(new LiteralControl("<tr>"));
            DIVCustomItem.Controls.Add(new LiteralControl("<td class='border center pad5 whitebg' colspan='2' style='width: 50%;text-align:center' vertical-align='top'>"));
    ...
    void btnDynDQ_Click(object sender, EventArgs e)
    {
        ...
        if (Convert.ToInt32(Session["PatientVisitId"]) == 0)
        {
            ...
            ViewState["VisitDate"] = txtvisitDate.Value;
    ...
    private void BindDrugControls(int DrugId, int Generic, int DrugType, int Flag)
    {
        ...
        if ((DrugType == 37 || DrugType == 36) && Flag == 0) //// DrugType-36 OI Med,37 ARV Med//// 
        {
            ...
            theDrugFrequency.CssClass = "form-control";
            if (Generic == 0)
            {
            ...
            theQtyPrescribed.CssClass = "form-control";
            if (Generic == 0)
            {
            ...
            theQtyDispensed.CssClass = "form-control";
            if (Generic == 0)
            {
        ...
        else
        {
            ...
            theFrequency.CssClass = "form-control";
            if (Generic == 0)
            {
    ...
    private void BindCustomControls(DataRow theDR)
    {
        ...
        if (theDVselectList.Count != 0)
        {
            ...
            theddlLabResult.CssClass = "form-control";
        ...
        else
        {
            ...
            theLabResult.CssClass = "form-control";
    ...
    private void BindValue(int PatientID, int VisitID, int LocationID, Control theControl, DataTable DTTabId)
    {
        ...
        if (!IsPostBack)
        {
            txtvisitDate.Value = String.Format("{0:dd-MMM-yyyy}", TmpDS.Tables[0].Rows[0]["VisitDate"]);
            ViewState["VisitDate"] = txtvisitDate.Value;
            if (Convert.ToInt32(TmpDS.Tables[0].Rows[0]["DataQuality"]) == 1)
            {
                btncomplete.CssClass = "btn btn-primary";
            }
    ...
    private StringBuilder SaveCustomFormData(int PatientID, DataSet DS, int DQSaveChk, int TabId)
    {
        ...
        if (Convert.ToInt32(Session["PatientVisitId"]) == 0)
        {
            ...
            if (IsSIngleVisit == true)
            {
                ...
                SbInsert.Append("Values(" + PatientID + "," + Session["AppLocationId"] + ",'" + txtvisitDate.Value + "'," + TempDS.Tables[0].Rows[0]["VisitTypeID"].ToString());
            ...
            if (IsSIngleVisit == true)
            {
                ...
                {
                    theRegVisitDate = txtvisitDate.Value;
                }
            ...
            if (DS.Tables[1].Rows.Count > 0 || DS.Tables[2].Rows.Count > 0)
            {
                ...
                if (ddSignature.SelectedValue == "")
                {
                    ...
                    SbInsert.Append("Values(" + PatientID + ",IDENT_CURRENT('Ord_Visit')," + Session["AppLocationId"] + "," + SecurityPerTabSignature + ", '" + txtvisitDate.Value + "',");
                ...
                {
                    SbInsert.Append("Insert into [ord_patientpharmacyorder](ptn_pk, VisitID, LocationID, OrderedBy, OrderedByDate, UserID, Signature, CreateDate,orderstatus)");
                    SbInsert.Append("Values(" + PatientID + ",IDENT_CURRENT('Ord_Visit')," + Session["AppLocationId"] + "," + ddSignature.SelectedValue + ", '" + txtvisitDate.Value + "',");
                    SbInsert.Append("" + Session["AppUserId"] + "," + Signature + ", getdate(),'" + orderstatus + "')");
                    SbInsert.Append("Select LocationID, ptn_pharmacy_pk[PharmacyID], UserID from ord_PatientPharmacyOrder where VisitID=IDENT_CURRENT('Ord_Visit')");
                }
            ...
            if (DS.Tables[0].Rows.Count > 0)
            {
                if (ddSignature.SelectedValue == "")
                {
                    ...
                    SbInsert.Append("Values(" + PatientID + ",IDENT_CURRENT('Ord_Visit')," + Session["AppLocationId"] + "," + SecurityPerTabSignature + ", '" + txtvisitDate.Value + "',");
                    SbInsert.Append("" + Signature + ", '" + txtvisitDate.Value + "'," + Session["AppUserId"] + ", getdate())");
    ...
    private StringBuilder UpdateCustomFormData(int PatientID, int FeatureID, int VisitID, int LocationID, DataSet DS, int DQChk, int TabId)
    {
        ...
        {
            SbUpdateParam.Append(" Update Ord_visit Set VisitDate='" + txtvisitDate.Value + "', Signature='" + Signature + "',DataQuality='" + DQChk.ToString() + "'where Ptn_Pk=" + PatientID + " and Visit_Id=" + VisitID + " and LocationID=" + LocationID + "");// and UserId=" + Session["AppUserId"] + "");
        }
        else
        {
        ...
        if (DS.Tables[1].Rows.Count > 0 || DS.Tables[2].Rows.Count > 0)
        {
            if (ddSignature.SelectedValue == "")
            {
                ...
                SbUpdateParam.Append(" Values(" + PatientID + "," + VisitID + "," + LocationID + "," + SecurityPerTabSignature + ", '" + txtvisitDate.Value + "',");
            ...
            else
            {
                ...
                SbUpdateParam.Append(" Begin");
                SbUpdateParam.Append(" Insert into [ord_patientpharmacyorder](ptn_pk, VisitID, LocationID, OrderedBy, OrderedByDate, UserID, Signature, CreateDate)");
                SbUpdateParam.Append(" Values(" + PatientID + "," + VisitID + "," + LocationID + "," + ddSignature.SelectedValue + ", '" + txtvisitDate.Value + "',");
                SbUpdateParam.Append(" " + Session["AppUserId"] + "," + Signature + ", getdate())");
                SbUpdateParam.Append(" End");
                SbUpdateParam.Append(" Select LocationID, ptn_pharmacy_pk[PharmacyID], UserID from ord_PatientPharmacyOrder where VisitID=" + VisitID + "");
            }
        ...
        if (DS.Tables[0].Rows.Count > 0)
        {
            if (ddSignature.SelectedValue == "")
            {
                ...
                SbUpdateParam.Append(" Values(" + PatientID + "," + VisitID + "," + LocationID + "," + SecurityPerTabSignature + ", '" + txtvisitDate.Value + "',");
                SbUpdateParam.Append("" + Signature + ", '" + txtvisitDate.Value + "'," + Session["AppUserId"] + ", getdate())");
                SbUpdateParam.Append(" End");
    ...
    private Boolean FieldValidation()
    {
        ...
        ICustomForm MgrValidate = (ICustomForm)ObjectFactory.CreateInstance(ObjFactoryParameter);
        DataSet theDS = MgrValidate.Validate(Header.InnerText, txtvisitDate.Value, Convert.ToString(Session["PatientId"]));
        ...
        // todo
        //if (txtvisitDate.Value != "01-01-1900")
        if (IsSIngleVisit == false)
        {
            DateTime VisitDate = Convert.ToDateTime((txtvisitDate.Value));
            DateTime RegisDate;
            if (theDS.Tables[1].Rows.Count != 0)
            {
            ...
            if (Convert.ToInt32(Session["PatientVisitId"]) > 0)
            {
                ...
                {
                    if (txtvisitDate.Value != Convert.ToString(ViewState["VisitDate"]))
                    {
