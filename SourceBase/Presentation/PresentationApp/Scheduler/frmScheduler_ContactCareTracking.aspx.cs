...
public partial class Scheduler_frmScheduler_ContactCareTracking : BasePage
{
    ...
    private void EnableDisableControls()
    {
        ...
        if (theControlsDS != null && theControlsDS.Tables.Count > 0)
        {
            /////////Table -0
    ...
    private void Bind_Combo()
    {
        ...
        if (theDV.Table.Rows.Count != 0)
        {
            ...
            //BindUserDropdown(ddinterviewer, string.Empty);
            BindUserDropdown(ddinterviewer, Session["AppUserId"].ToString());
            //theDT.Clear();
        }
                        ...
                        if (theConditional == true)
                        {
                            for (int i = 0; i < theDVConditionalField.Count; i++)
                            {
                                if (td == 0)
                                {
                                    ...
                                    //DIVCustomItem.Controls.Add(new LiteralControl("<td  class='form' align='center' width='50%'>"));
                                    DIVCustomItem.Controls.Add(new LiteralControl("<div class='col-md-3 col-sm-12 col-xs-12 form-group'>"));
                                    DIVCustomItem.Controls.Add(new LiteralControl("<label class='control-label'>"));
    ...
    private void LoadFieldTypeControl(DataView ReqDv, Panel thePnl, string FeatureName, string SectionId, string SectionName, string CFieldId, string FieldLabel, string FieldName, string ControlID, string SavingTable, string BindingTable, string PreDefined, bool theEnable)
    {
        ...
        else if (ControlID == "2") ///DecimalTextBox
        {
            ...
            theSingleDecimalText.CssClass = "udform-control";
        ...
        else if (ControlID == "3")   /// Numeric (Integer)
        {
            ...
            theNumberText.CssClass = "udform-control";
        ...
        else if (ControlID == "4") /// Dropdown
        {
            ...
            ddlSelectList.CssClass = "udform-control";
        ...
        else if (ControlID == "5") ///Date
        {
            ...
            theDateText.CssClass = "udform-control";
        ...
        else if (ControlID == "6")  /// Radio Button
        {
            ...
            theYesNoRadio1.Attributes.Add("class", "checkbox-btn");
            if (theConditional == true && theEnable == true)
        ...
        else if (ControlID == "7") //Checkbox
        {
            ...
            theChk.Attributes.Add("class", "checkbox-btn");
        ...
        else if (ControlID == "8")  /// MultiLine TextBox
        {
            ...
            theMultiText.CssClass = "udform-control";
    ...
    private void cmbboxLoad(DataTable theDT, DataView DVReq,string patval)
    {
        ...
        if (theDT.Rows.Count > 0)
        {
            ...
            foreach (DataRow theDR in theDT.Rows)
            {
                ...
                PnlConFields.Controls.Add(new LiteralControl("<td  class='form control-label' align='center' width='50%'>"));
                //PnlConFields.Controls.Add(new LiteralControl("<div align='center'>"));               
                ...
                //PnlConFields.Controls.Add(new LiteralControl("</div>"));
