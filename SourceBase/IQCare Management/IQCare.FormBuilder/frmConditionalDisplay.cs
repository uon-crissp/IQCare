...
namespace IQCare.FormBuilder
{
    public partial class frmConditionalDisplay : Form
    {
        ...
        DataTable theExistingFields = new DataTable();
        ...
        private void Init_Form()
        {
            ...
            theExistingFields = dsFieldDetails.Tables[1].Copy();
        ...
        private void btnBack_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                /////////////Form Version Chaeck/////////////////////
                if (dsFieldDetails.Tables[2].Rows.Count > 0 && GblIQCare.iManageCareEnded==0)
                {
                    if (!CheckFormVersion(theGrdSource.Copy(), theExistingFields))
                    {
                        ...
                        if (msgconfirm == DialogResult.OK)
                        {
                            ...
                            DSFormVerTables.Tables.Add(dsFieldDetails.Tables[2].Copy());
                ...
                if(DSFormVerTables !=null)
                    GblIQCare.dsFormversionFieldDetails = DSFormVerTables.Copy();
                this.Close();
            }
            catch (Exception err)
            {
        ...
        private bool CheckFormVersion(DataTable NewData, DataTable dsUpdateMode)
        {
            dtConFieldchanges = clsCommon.ManageVersionConField();
            DataRow dr;

            ////////////////////// Conditional Field Check /////////////////////////////////
            var qryConField1 = dsUpdateMode.AsEnumerable()
                               .Select(a => new { FieldId = a["FieldId"].ToString(), ConFieldId = a["ConFieldId"].ToString(), fieldpredefined = a["predefined"].ToString(), Conditionalfieldpredefined = a["ConPredefine"].ToString() });
            var qryConField2 = NewData.AsEnumerable()
                                .Select(b => new { FieldId = b["FieldId"].ToString(), ConFieldId = b["ConFieldId"].ToString(), fieldpredefined = b["predefined"].ToString(), Conditionalfieldpredefined = b["ConPredefine"].ToString() });
            ...
            ////////////////////////////////////////////////////////////////////////////////
            if (dtConFieldchanges.Rows.Count > 0)
            {
                return false;
            }
